 ...
 * ============================================================
 * 英国视角 02/03/04 子模块存档
 * 原文件: src/components/modules/global-investor/UKSubModule.tsx
 * 存档日期: 2026-06-17
 * 恢复方法: 将以下三个组件定义和渲染调用添加回 UKSubModule.tsx
 * ============================================================
 */
...
// ============================================================
// 子模块 4：供给竞争 — 美国 Treasury 供给 vs 英国 Gilt 供给
// ============================================================
...
/* ============================================================
 * B 跨市场利差：Gilt vs Bund / UST 的三方比较 (RelativeValue)
 * 存档日期: 2026-06-17 (10:16)
 * ============================================================ */
